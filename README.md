...
### API tests
API tests are done for the following routes `/individual-trainees` , `/courses`, `/instructors`, `/courses/:courseId/ratings`
#### Example test for course route
```typescript
